...
class Jutranslation
{
    ...
    protected static function saveStrings()
    {
        ...
        // Remove old single file translation
        $singleFileRenderPath = WP_CONTENT_DIR . DIRECTORY_SEPARATOR . wpfd_get_content_dir() . DIRECTORY_SEPARATOR . 'renderer' . DIRECTORY_SEPARATOR . 'singlefile.php';
        if (((string)$plugin === 'wpfd' || (string)$plugin === 'wpfd-addon') && file_exists($singleFileRenderPath)) {
            unlink($singleFileRenderPath);
        }
