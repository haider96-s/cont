...
class WpfdModelCategories extends Model
{
    ...
    public function extractOwnCategories($items)
    {
        ...
        if (!empty($items) && !$is_edit_all) {
            ...
            /**
             * Filter to set user categories for current user
             *
             * @param array Categories which belong to user
             ...
             * @internal
             */
            $user_categories  = apply_filters('wpfdUserCategories', $user_categories, $user_id);
