...
class WpfdModelFile extends Model
{
    ...
    public function getFile($id_file)
    {
        ...
        $row['title'] = stripslashes(htmlspecialchars_decode(wp_slash_strings_only($row['post_title'])));
    ...
    public function save($datas)
    {
        ...
        $metadata['file_custom_icon_preview'] = $datas['file_custom_icon_preview'];
        ...
        if (isset($datas['remoteurl']) && !empty($datas['remoteurl'])) {
            ...
            if (isset($metadata['wpfd_sync_ftp_file']) && $metadata['wpfd_sync_ftp_file']) {
                $datas['remoteurl'] = $metadata['file'];
            } else {
                $metadata['file'] = $datas['remoteurl'];
            }

            if (file_exists($datas['remoteurl'])) {
                $metadata['size'] = filesize($datas['remoteurl']);
            } else {
