                                                ...
                                                return (
                                                    ...
                                                    >
                                                      ...
                                                      {category.cloudType === category.term_id || category.cloudType === false
                                                          ? <i className="zmdi zmdi-folder" style={{color: category.color}} />
                                                          : <i className={'zmdi zmdi-folder wpfd-icon-cloud wpfd-icon-' + category.cloudType.toString().replace('_', '-')} style={{color: category.color}} />
                                                      }
