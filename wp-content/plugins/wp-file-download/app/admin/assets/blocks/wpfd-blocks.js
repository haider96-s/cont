                  ...
                  loading ? wp.element.createElement(
                    ...
                    categoriesList.length > 0 ? filterCategoryResults.length > 0 ? filterCategoryResults.map(function (category, index) {
                      ...
                      return wp.element.createElement(
                        ...
                        category.cloudType === category.term_id || category.cloudType === false ? wp.element.createElement("i", { className: "zmdi zmdi-folder", style: { color: category.color } }) : wp.element.createElement("i", { className: 'zmdi zmdi-folder wpfd-icon-cloud wpfd-icon-' + category.cloudType.toString().replace('_', '-'), style: { color: category.color } }),
                        wp.element.createElement(
                          "span",
