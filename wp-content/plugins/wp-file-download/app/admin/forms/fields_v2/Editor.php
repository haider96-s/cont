...
class Editor extends Field
{
    ...
    public function getfield($field, $data)
    {
        ...
        $html      .= '<p title="' . esc_html__($msg_title, 'wpfd') . '">
                    Support tag: {category}, {receiver}, {username}, {website_url}, {file_name}, {file_download_url}, {date_upload}
                 </p>';
        $html      .= '</div></div>';
                                        ...
                                        <table border = "0" width = "100%" cellspacing = "0" cellpadding = "0" >
                                          <tbody>
                                            <tr>
                                              <td class="bodycopy" 
                                              style = "color: #153643; font-family: sans-serif; font-size: 16px; line-height: 22px;" >
                                              The WP File Download file named <a style="color: #153643; text-decoration: none; font-weight: bold;" href="{file_download_url}">{file_name}</a>, upload date: {date_upload} has been '
                                              . $valueEvent . ' by a user who owns it or an administrator, you can visit the website to get more information about it.
                                               </td>
                                            </tr>
                                            <tr>
