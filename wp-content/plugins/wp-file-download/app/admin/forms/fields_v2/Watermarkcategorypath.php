...
/**
 * Class Watermarkcategorypath
 */
class Watermarkcategorypath extends Field
{
    /**
    ...
    public function getfield($field, $data)
    {
        ...
        $html .= ' />';
        $html .= '<input id="wm_category_select_media_button" class="button select-media" type="button"';
