...
class Singleshortcode extends Typeint
{
    ...
    public function getfield($field, $data)
    {
        ...
        if (!empty($attributes['label']) && $attributes['label'] !== '' &&
            ...
            $html .= esc_html__($attributes['label'], 'wpfd');
            $html .= '<small>';
        ...
        $categoryFrom = apply_filters('wpfdAddonCategoryFrom', $fileInfo['catid']);
        if ($categoryFrom === 'aws') {
            $fileInfo['fileId'] = stripslashes(htmlspecialchars($fileInfo['fileId']));
        }
