                    ...
                    <div class="wpfd-card-body" style="display:none;">
                        <div class="wpfd-flex">
                            ...
                            <div class="wpfd-col-flex flex-half">
                                ...
                                <div class="ju-option-group wpfd-option" data-id="ju_preview_icon">
                                    <label class="wpfd-label"><?php esc_html_e('JoomUnited Preview Icon', 'wpfd'); ?></label>
                                    <div class="ju-switch-button">
                                        <label class="switch">
                                            <?php $checked = WpfdBase::loadValue($singleFileParams, 'ju_preview_icon', true) ? 'checked="checked"' : ''; ?>
                                            <input type="checkbox" name="ref_ju_preview_icon" <?php echo $checked; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- It's OK ?>/>
                                            <span class="slider"></span>
                                        </label>
                                        <input type="hidden" name="ju_preview_icon" value="<?php echo (WpfdBase::loadValue($singleFileParams, 'ju_preview_icon', true) ? '1' : '0'); ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="wpfd-col-flex flex-full">
