    ...
    <div class="wpfd-file wpfd-single-file" data-file="<?php echo esc_attr($file->ID); ?>">
        <div class="wpfd-file-link">
            ...
            <div class="wpfd_single_footer">
                ...
                <a class="wpfd_single_view_product" href="<?php echo esc_url($file->viewerlink); ?>" target="_blank" <?php echo $rel; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Data attributes ?>>
                ...
                <?php else : ?>
                    <?php if (isset($file->openpdflink)) {
                        ...
                        ?>
                        <a href="<?php echo esc_url($file->openpdflink); ?>" class="<?php echo esc_attr($classes); ?>"<?php echo $target; // phpcs:ignore?> <?php echo $rel; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Data attributes ?>>
