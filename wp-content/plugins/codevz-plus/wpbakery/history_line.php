...
class Codevz_WPBakery_history_line {
	...
	public function in( $wpb = false ) {
		...
		$settings = array(
			...
			'base'			=> $this->name,
			'name'			=> esc_html__( 'History Timeline', 'codevz-plus' ),
			'description'	=> esc_html__( 'Events timeline', 'codevz-plus' ),
			'icon'			=> 'czi',
			'is_container' 	=> true,
			...
			'params'		=> array(
				...
				array(
					"type"        	=> "textfield",
					"heading"     	=> esc_html__("Year title", 'codevz-plus' ),
					'value' 		=> gmdate( 'Y' ),
				...
				array(
					...
					'button' 		=> esc_html__( "Year", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
				...
				array(
					...
					"heading"     	=> esc_html__( "Circle", 'codevz-plus' ),
					'button' 		=> esc_html__( "Circle", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
