...
class Codevz_WPBakery_contact_form_7 {
	...
	public function in( $wpb = false ) {
		...
		$contact_forms = array( esc_html__( 'Select Contact Form', 'codevz-plus' ) => 0 );
		if ( $cf7 ) {
			foreach ( $cf7 as $cform ) {
				$contact_forms[ $cform->post_title ] = $cform->post_title;
			}
		} else {
			$contact_forms[ esc_html__( 'No contact forms found', 'codevz-plus' ) ] = 0;
		}

		$settings = array(
			'category'		=> Codevz_Plus::$title,
			'base'			=> $this->name,
			'name'			=> esc_html__( 'Contact Form 7 Pro', 'codevz-plus' ),
			'description'	=> esc_html__( 'Stylish contact form 7', 'codevz-plus' ),
			'icon'			=> 'czi',
			'params'		=> array(
				array(
					'type' 			=> 'cz_sc_id',
				...
				array(
					'type' 			=> 'dropdown',
					'heading' 		=> esc_html__( 'Contact Form', 'codevz-plus' ),
					'description' 	=> esc_html__( 'This element required plugin Contact Form 7, You can install it via Dashboard > Plugins > Add New', 'codevz-plus' ),
					'param_name' 	=> 'cf7',
					'value' 		=> $contact_forms,
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_label',
					"heading"     	=> esc_html__( "Labels", 'codevz-plus' ),
					'button' 		=> esc_html__( "Labels", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
				...
				array(
					...
					'param_name' 	=> 'cz_title',
					'class' 		=> '',
					'content' 		=> esc_html__( 'Styling each row', 'codevz-plus' ),
				),
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p',
					"heading"     	=> esc_html__( "All rows", 'codevz-plus' ),
					'button' 		=> esc_html__( "All rows", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_1',
					"heading"     	=> esc_html__( "Field 1", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 1", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_2',
					"heading"     	=> esc_html__( "Field 2", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 2", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'float', 'padding', 'margin', 'border' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_3',
					"heading"     	=> esc_html__( "Field 3", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 3", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'float', 'padding', 'margin', 'border' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_4',
					"heading"     	=> esc_html__( "Field 4", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 4", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'float', 'padding', 'margin', 'border' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_5',
					"heading"     	=> esc_html__( "Field 5", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 5", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'float', 'padding', 'margin', 'border' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_6',
					"heading"     	=> esc_html__( "Field 6", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 6", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'float', 'padding', 'margin', 'border' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_7',
					"heading"     	=> esc_html__( "Field 7", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 7", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'float', 'padding', 'margin', 'border' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_8',
					"heading"     	=> esc_html__( "Field 8", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 8", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'float', 'padding', 'margin', 'border' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_9',
					"heading"     	=> esc_html__( "Field 9", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 9", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'float', 'padding', 'margin', 'border' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_10',
					"heading"     	=> esc_html__( "Field 10", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 10", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_11',
					"heading"     	=> esc_html__( "Field 11", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 11", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'background', 'padding', 'margin', 'border', 'box-shadow' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_12',
					"heading"     	=> esc_html__( "Field 12", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 12", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'background', 'padding', 'margin', 'border', 'box-shadow' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_13',
					"heading"     	=> esc_html__( "Field 13", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 13", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'background', 'padding', 'margin', 'border', 'box-shadow' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_14',
					"heading"     	=> esc_html__( "Field 14", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 14", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'background', 'padding', 'margin', 'border', 'box-shadow' )
				),
				...
				array(
					'type' 			=> 'cz_sk',
					'param_name' 	=> 'sk_p_15',
					"heading"     	=> esc_html__( "Field 15", 'codevz-plus' ),
					'button' 		=> esc_html__( "Field 15", 'codevz-plus' ),
					'edit_field_class' => 'vc_col-xs-99',
					'settings' 		=> array( 'width', 'background', 'padding', 'margin', 'border', 'box-shadow' )
				),
