=== Codevz Plus - Extension for XTRA Theme ===
Contributors: Codevz
Tags: widgets, elements, options, xtra, website builder
...
Codevz plus plugin is an custom extension plugin developed for XTRA WordPress theme.

== Description ==

Codevz plus is an custom extension plugin developed for XTRA WordPress theme with a lot of widgets, elements, options, and other features.
...
5. Search and install it easily

For documentation and tutorials visit our [Knowledge Base](https://xtratheme.com/docs).

== Frequently Asked Questions ==

**Can I use this plugin onther themes?**

Yes, you can but this plugin developed specially for XTRA WordPress theme.

**Everything in this plugin is free?**

No, some widgets, elements, options, and etc. are for PRO users only. 
...
* Initial release on WordPress plugins directory

[See changelog for all versions.](https://xtratheme.com/changelog)
